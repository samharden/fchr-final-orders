...
folder `angular-finalordercat-snapshots`, which then contains an additional folder called `sandbox`.
...
- **snaphot.sh**: Run this script to generate the `angular-finalordercat-snapshots` folder, containing
...
The finalorder data used by the application is scraped from a Google search page.

- ScrapeData.js: Run this script using node.js to access the web page containing the finalorder data and
  copy the data into the `app/finalorders` folder.
